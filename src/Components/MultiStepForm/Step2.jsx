    ...
    <div className="transition-opacity  transform duration-500">
      <div className="mt-10 bg-[#e8eef1] rounded-lg p-7">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-3 my-5">
          <div className="pl-2 border w-full bg-white mx-auto border-gray-400 rounded flex items-center h-10 ">
            <input
              type="radio"
              className="w-4 h-4"
              id="noReceipt"
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    accommodationAmount: e.target.value,
                  })
                }
                required
              />
